...
<div className=" absolute w-full flex md:flex-row bg-transparent border-opacity-10 border-0 border-white solid items-center text-sm ">
          <div className='md:flex justify-start px-4 md:px-20 py-4 border-opacity-10  border-white solid'>
            <div className='border-1 border-white solid hover:opacity-80'>
            <Link href='/'>
          ...
          <div className='flex justify-end md:flex-row w-full'>
        
            
            <div className="flex justify-end md:pr-20 py-4">
             
              <Button className="flex bg-white text-black shadow font-semibold  hover:bg-slate-700 hover:text-white hover:transition-width hover:shadow-lg rounded-full text-sm py-2" 
               >
                <PhoneCallIcon className='pr-2' /> KOMIN CONTACT
              </Button>
            </div>
          </div>
        </div> </>
