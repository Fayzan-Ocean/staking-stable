 ...
 if (!hasMounted) return null;
    ...
    <Card className="relative overflow-hidden w-[33%]">
      ...
      {/*   <Dialog>
        ...
        <Button className="flex w-full" disabled={!writeUsdcApprove || Number(balanceUSDT?.data?.formatted)<0} onClick={()=>{ writeUsdcApprove?.()
       ...
       {/*  <Dialog>
        ...
        <DialogContent >
            ...
            <div className="flex flex-col justify-center align-middle pt-4 items-center">
            {isLoadingUsdtApprove || isLoadingTransactionApprove && !isErrorUsdtApprove ?  
            <> 
             <DialogTitle className="flex  justify-center align-middle items-center py-8">Waiting for Approval</DialogTitle>
            <ReloadIcon className="mr-2 h-12 w-12 animate-spin mb-8" />
            </> : 
