...
import DepositCardUsdt from "@/components/DepositCardUsdt"
...
<div className='flex justify-center'>
  ...
  <TabsContent value="deposit" className='w-full'>
      ...
      <div className='flex flex-col justify-center w-full pt-10 gap-4'>
        ...
        <div className='flex justify-center text-lg'>  
          ...
          <TabsList className='flex justify-end  '>
            <TabsTrigger value="usdc" className='text-xs font-medium gap-1'>
              <svg
            style={{
          ...
          >
            ...
            <defs>
              ...
              USDC</TabsTrigger>
            <TabsTrigger value="usdt" className=' text-xs font-medium gap-1'>
            <svg
            width={20}
            height={20}
            viewBox="0 0 25 25"
      ...
      <div className='flex justify-center w-full '><DepositUsdc  />
      </div>
      
    </TabsContent>
      <TabsContent value="usdt" className='w-full'>
      <div className='flex justify-center w-full '>  <DepositUsdt  />
      </div>
  ...
  <TabsContent value="withdraw" className='w-full'>
    <Withdraw />
      ...
      <TabsContent value="usdc" className='w-full'>
      <div className='flex justify-center w-full '><WithdrawUsdc  />
      </div>

      </TabsContent>
      <TabsContent value="usdt" className='w-full'>
      <div className='flex justify-center w-full '>  <WithdrawUsdt  />
      </div>
